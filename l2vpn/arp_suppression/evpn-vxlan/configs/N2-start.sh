...
ip link set br100 address aa:c1:ab:70:00:a1
...
ip link set dev vxlan100 type bridge_slave neigh_suppress on learning off
# ip link set dev vxlan100 promisc on
ip link set dev vxlan100 up

# ip addr add 192.168.0.254/24 dev br100 

# tcpdump -c 1000 -i eth1 -w N2-eth1.pcap &
